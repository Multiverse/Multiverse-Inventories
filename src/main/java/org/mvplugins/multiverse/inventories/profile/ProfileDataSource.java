...
public final class ProfileDataSource {
    ...
    @Inject
    ProfileDataSource(MultiverseInventories plugin) throws IOException {
     ...
     * @throws IOException if there was a problem creating the file.
     */
    private File getGlobalFile(String fileName, boolean createIfMissing) throws IOException {
