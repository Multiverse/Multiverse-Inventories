package com.onarandombox.multiverseinventories.share.handlers;
...
public abstract class AbstractShareHandler {
    ...
    AbstractShareHandler(MultiverseInventories inventories, Player player) {
    ...
    public abstract ShareHandlingEvent createEvent();
