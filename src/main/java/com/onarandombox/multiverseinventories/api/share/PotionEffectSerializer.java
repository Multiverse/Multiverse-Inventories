...
/**
 * A simple {@link com.onarandombox.multiverseinventories.api.share.SharableSerializer} usable with PotionEffect[] which converts the PotionEffect[] to the string format
