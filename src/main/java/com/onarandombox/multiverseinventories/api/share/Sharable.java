...
public enum Sharable {
    ...
    /**
     * @param profile Updates the data of this player according to the Sharable
     *                with the values of the player.
     * @param player  The player whose values will be used to update the given player.
     */
     ...
     *                with the values of the given player.
     * @param profile The player whose values will be used to update the give player.
     */
