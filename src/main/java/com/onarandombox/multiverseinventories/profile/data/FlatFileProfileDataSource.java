package com.onarandombox.multiverseinventories.profile.data;
...
import com.onarandombox.multiverseinventories.profile.utils.ProfileKey;
...
public class FlatFileProfileDataSource implements ProfileDataSource {
    ...
    public FlatFileProfileDataSource(MultiverseInventories plugin) throws IOException {
